...
export class InteractiveUI {
    ...
    async selectFromList(items, displayFn, message = 'Select an option', defaultValue) {
        ...
        return new Promise((resolve) => {
            ...
            this.readline.question(promptText, (answer) => {
                this.readline.close();
    ...
    async getTextInput(prompt, defaultValue, hidden = false) {
        if (!this.config.ui.interactive) {
